set moduleName packet_identificatio
set isTopModule 0
...
set C_modelName {packet_identificatio}
set C_modelType { void 0 }
set C_modelArgList {
	{ dataIn_V_data_V int 512 regular {axi_s 0 volatile  { s_axis Data } }  }
	{ dataIn_V_keep_V int 64 regular {axi_s 0 volatile  { s_axis Keep } }  }
	{ dataIn_V_last_V int 1 regular {axi_s 0 volatile  { s_axis Last } }  }
	{ eth_level_pkt_V int 580 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "dataIn_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "eth_level_pkt_V", "interface" : "fifo", "bitwidth" : 580, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ eth_level_pkt_V_din sc_out sc_lv 580 signal 3 } 
	{ eth_level_pkt_V_full_n sc_in sc_logic 1 signal 3 } 
	{ eth_level_pkt_V_write sc_out sc_logic 1 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "eth_level_pkt_V_din", "direction": "out", "datatype": "sc_lv", "bitwidth":580, "type": "signal", "bundle":{"name": "eth_level_pkt_V", "role": "din" }} , 
 	{ "name": "eth_level_pkt_V_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "eth_level_pkt_V", "role": "full_n" }} , 
 	{ "name": "eth_level_pkt_V_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "eth_level_pkt_V", "role": "write" }} , 
 	{ "name": "start_out", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "start_out", "role": "default" }} , 
 	{ "name": "start_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "start_write", "role": "default" }} , 
 	{ "name": "s_axis_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "dataIn_V_data_V", "role": "default" }} , 
 	{ "name": "s_axis_TREADY", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "inacc", "bundle":{"name": "dataIn_V_last_V", "role": "default" }} , 
 	{ "name": "s_axis_TKEEP", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "dataIn_V_keep_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "eth_level_pkt_V", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	dataIn_V_data_V { axis {  { s_axis_TVALID in_vld 0 1 }  { s_axis_TDATA in_data 0 512 } } }
	dataIn_V_keep_V { axis {  { s_axis_TKEEP in_data 0 64 } } }
	dataIn_V_last_V { axis {  { s_axis_TREADY in_acc 1 1 }  { s_axis_TLAST in_data 0 1 } } }
	eth_level_pkt_V { ap_fifo {  { eth_level_pkt_V_din fifo_data 1 580 }  { eth_level_pkt_V_full_n fifo_status 0 1 }  { eth_level_pkt_V_write fifo_update 1 1 } } }
}
