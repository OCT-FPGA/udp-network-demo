...
unsigned int ap_apatb_dataOut_V_last_V_V_cap_bc;
static AESL_RUNTIME_BC __xlx_dataOut_V_last_V_V_size_Reader("../tv/stream_size/stream_size_out_dataOut_V_last_V.dat");
unsigned int ap_apatb__V_cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
unsigned int ap_apatb__V_cap_bc;
static AESL_RUNTIME_BC __xlx__V_size_Reader("../tv/stream_size/stream_size_out_.dat");
unsigned int ap_apatb_arpTableReplay_V_cap_bc;
static AESL_RUNTIME_BC __xlx_arpTableReplay_V_size_Reader("../tv/stream_size/stream_size_in_arpTableReplay_V.dat");
unsigned int ap_apatb_arpTableRequest_V_cap_bc;
static AESL_RUNTIME_BC __xlx_arpTableRequest_V_size_Reader("../tv/stream_size/stream_size_out_arpTableRequest_V.dat");
...
extern "C" void apatb_ethernet_header_inserter_hw(volatile void * __xlx_apatb_param_dataIn_V_data_V, volatile void * __xlx_apatb_param_dataIn_V_keep_V, volatile void * __xlx_apatb_param_dataIn_V_strb_V, volatile void * __xlx_apatb_param_dataIn_V_last_V, volatile void * __xlx_apatb_param_dataOut_V_data_V, volatile void * __xlx_apatb_param_dataOut_V_keep_V, volatile void * __xlx_apatb_param_dataOut_V_strb_V, volatile void * __xlx_apatb_param_dataOut_V_last_V, volatile void * __xlx_apatb_param_arpTableReplay, volatile void * __xlx_apatb_param_arpTableRequest, volatile void * __xlx_apatb_param_myMacAddress, volatile void * __xlx_apatb_param_regSubNetMask, volatile void * __xlx_apatb_param_regDefaultGateway) {
  ...
  ap_apatb_dataIn_V_data_V_V_cap_bc = __xlx_dataIn_V_data_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_dataIn_V_keep_V_V_cap_bc = __xlx_dataIn_V_keep_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_dataIn_V_strb_V_V_cap_bc = __xlx_dataIn_V_strb_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_dataIn_V_last_V_V_cap_bc = __xlx_dataIn_V_last_V_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_dataOut_V_data_V_V_cap_bc = __xlx_dataOut_V_data_V_V_size_Reader.read_size();
  __cosim_s40__* __xlx_dataOut_V_data_V_input_buffer= new __cosim_s40__[ap_apatb_dataOut_V_data_V_V_cap_bc];
  //Create input buffer for dataOut_V_keep_V
  ap_apatb_dataOut_V_keep_V_V_cap_bc = __xlx_dataOut_V_keep_V_V_size_Reader.read_size();
  long long* __xlx_dataOut_V_keep_V_input_buffer= new long long[ap_apatb_dataOut_V_keep_V_V_cap_bc];
  //Create input buffer for dataOut_V_strb_V
  ap_apatb_dataOut_V_strb_V_V_cap_bc = __xlx_dataOut_V_strb_V_V_size_Reader.read_size();
  long long* __xlx_dataOut_V_strb_V_input_buffer= new long long[ap_apatb_dataOut_V_strb_V_V_cap_bc];
  //Create input buffer for dataOut_V_last_V
  ap_apatb_dataOut_V_last_V_V_cap_bc = __xlx_dataOut_V_last_V_V_size_Reader.read_size();
  char* __xlx_dataOut_V_last_V_input_buffer= new char[ap_apatb_dataOut_V_last_V_V_cap_bc];
  ...
  ap_apatb_arpTableReplay_V_cap_bc = __xlx_arpTableReplay_tmp_vec.size();
  // store input buffer
  ...
  ap_apatb_arpTableRequest_V_cap_bc = __xlx_arpTableRequest_V_size_Reader.read_size();
  __cosim_s4__* __xlx_arpTableRequest_input_buffer= new __cosim_s4__[ap_apatb_arpTableRequest_V_cap_bc];
  // DUT call
  ...
  for (unsigned i = 0; i <ap_apatb_dataOut_V_last_V_V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_dataOut_V_last_V)->write(__xlx_dataOut_V_last_V_input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb__V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_)->write(__xlx__input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb__V_cap_bc; ++i)
    ((hls::stream<char>*)__xlx_apatb_param_)->write(__xlx__input_buffer[i]);
  for (unsigned i = 0; i <ap_apatb_arpTableRequest_V_cap_bc; ++i)
