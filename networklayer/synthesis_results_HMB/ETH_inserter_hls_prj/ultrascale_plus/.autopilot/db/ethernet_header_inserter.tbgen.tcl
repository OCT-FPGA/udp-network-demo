...
set C_modelArgList {
	...
	{ arpTableReplay_V int 128 regular {axi_s 0 volatile  { arpTableReplay_V Data } }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "dataIn_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "arpTableReplay_V", "interface" : "axis", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ arpTableReplay_V_TDATA sc_in sc_lv 128 signal 8 } 
	{ arpTableRequest_V_TDATA sc_out sc_lv 32 signal 9 } 
	...
	{ arpTableRequest_V_TVALID sc_out sc_logic 1 outvld 9 } 
	{ arpTableRequest_V_TREADY sc_in sc_logic 1 outacc 9 } 
	{ arpTableReplay_V_TVALID sc_in sc_logic 1 invld 8 } 
	{ arpTableReplay_V_TREADY sc_out sc_logic 1 inacc 8 } 
...
set NewPortList {[ 
	{ "name": "dataIn_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "dataIn_V_data_V", "role": "default" }} , 
 	...
 	{ "name": "arpTableReplay_V_TDATA", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "arpTableReplay_V", "role": "TDATA" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "7", "8", "14", "15", "16", "17"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "broadcaster_and_mac_request_U0"},
			{"ID" : "8", "Name" : "handle_output_U0"}],
		"OutputProcess" : [
			{"ID" : "8", "Name" : "handle_output_U0"}],
		"Port" : [
			{"Name" : "dataIn_V_data_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "dataIn_V_data_V"}]},
			{"Name" : "dataIn_V_keep_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "dataIn_V_keep_V"}]},
			{"Name" : "dataIn_V_strb_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "dataIn_V_strb_V"}]},
			{"Name" : "dataIn_V_last_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "dataIn_V_last_V"}]},
			{"Name" : "dataOut_V_data_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "dataOut_V_data_V"}]},
			{"Name" : "dataOut_V_keep_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "dataOut_V_keep_V"}]},
			{"Name" : "dataOut_V_strb_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "dataOut_V_strb_V"}]},
			{"Name" : "dataOut_V_last_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "dataOut_V_last_V"}]},
			{"Name" : "arpTableReplay_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "arpTableReplay_V"}]},
			{"Name" : "arpTableRequest_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "arpTableRequest_V"}]},
			{"Name" : "myMacAddress", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "myMacAddress"}]},
			{"Name" : "regSubNetMask", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "regSubNetMask"}]},
			{"Name" : "regDefaultGateway", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "regDefaultGateway"}]},
			{"Name" : "bmr_fsm_state", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "bmr_fsm_state"}]},
			{"Name" : "ip_header_out", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "compute_and_insert_ip_checksum_U0", "Port" : "ip_header_out"},
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "ip_header_out"}]},
			{"Name" : "no_ip_header_out", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "broadcaster_and_mac_request_U0", "Port" : "no_ip_header_out"},
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "no_ip_header_out"}]},
			{"Name" : "ip_header_checksum", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "7", "SubInstance" : "compute_and_insert_ip_checksum_U0", "Port" : "ip_header_checksum"},
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "ip_header_checksum"}]},
			{"Name" : "mw_state", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "mw_state"}]},
			{"Name" : "previous_word_data_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "previous_word_data_V"}]},
			{"Name" : "previous_word_keep_V", "Type" : "OVld", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "handle_output_U0", "Port" : "previous_word_keep_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0", "Parent" : "0", "Child" : ["2", "3", "4", "5", "6"],
		...
		"Port" : [
			...
			{"Name" : "regDefaultGateway", "Type" : "None", "Direction" : "I"},
			{"Name" : "bmr_fsm_state", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "ip_header_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "7", "DependentChan" : "14", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ip_header_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "no_ip_header_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "15", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "no_ip_header_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0.regslice_both_dataIn_V_data_V_U", "Parent" : "1"},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0.regslice_both_dataIn_V_keep_V_U", "Parent" : "1"},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0.regslice_both_dataIn_V_strb_V_U", "Parent" : "1"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0.regslice_both_dataIn_V_last_V_U", "Parent" : "1"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.broadcaster_and_mac_request_U0.regslice_both_arpTableRequest_V_U", "Parent" : "1"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute_and_insert_ip_checksum_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "ip_header_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "14", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ip_header_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "ip_header_checksum", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "8", "DependentChan" : "16", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ip_header_checksum_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.handle_output_U0", "Parent" : "0", "Child" : ["9", "10", "11", "12", "13"],
		"CDFG" : "handle_output",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "previous_word_data_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "previous_word_keep_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "ip_header_checksum", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "7", "DependentChan" : "16", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "ip_header_checksum_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "no_ip_header_out", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "15", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "no_ip_header_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_output_U0.regslice_both_arpTableReplay_V_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_output_U0.regslice_both_dataOut_V_data_V_U", "Parent" : "8"},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_output_U0.regslice_both_dataOut_V_keep_V_U", "Parent" : "8"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_output_U0.regslice_both_dataOut_V_strb_V_U", "Parent" : "8"},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.handle_output_U0.regslice_both_dataOut_V_last_V_U", "Parent" : "8"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ip_header_out_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.no_ip_header_out_U", "Parent" : "0"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ip_header_checksum_U", "Parent" : "0"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_compute_and_insert_ip_checksum_U0_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	arpTableReplay_V { axis {  { arpTableReplay_V_TDATA in_data 0 128 }  { arpTableReplay_V_TVALID in_vld 0 1 }  { arpTableReplay_V_TREADY in_acc 1 1 } } }
	arpTableRequest_V { axis {  { arpTableRequest_V_TDATA out_data 1 32 }  { arpTableRequest_V_TVALID out_vld 1 1 }  { arpTableRequest_V_TREADY out_acc 0 1 } } }
