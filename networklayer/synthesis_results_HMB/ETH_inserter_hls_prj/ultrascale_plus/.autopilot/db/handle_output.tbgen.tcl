...
set portList { 
	...
	{ arpTableReplay_V_TDATA sc_in sc_lv 128 signal 0 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_arpTableReplay_V_U", "Parent" : "0"},
...
set Spec2ImplPortList { 
	arpTableReplay_V { axis {  { arpTableReplay_V_TVALID in_vld 0 1 }  { arpTableReplay_V_TDATA in_data 0 128 }  { arpTableReplay_V_TREADY in_acc 1 1 } } }
