...
set C_modelArgList {
	...
	{ ip_header_checksum_V int 577 regular {fifo 0 volatile } {global 0}  }
	{ no_ip_header_out_V int 577 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "arpTableReplay_V", "interface" : "axis", "bitwidth" : 56, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "ip_header_checksum_V", "interface" : "fifo", "bitwidth" : 577, "direction" : "READONLY", "extern" : 0} , 
 	{ "Name" : "no_ip_header_out_V", "interface" : "fifo", "bitwidth" : 577, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ no_ip_header_out_V_dout sc_in sc_lv 577 signal 6 } 
	{ no_ip_header_out_V_empty_n sc_in sc_logic 1 signal 6 } 
	{ no_ip_header_out_V_read sc_out sc_logic 1 signal 6 } 
	{ ip_header_checksum_V_dout sc_in sc_lv 577 signal 5 } 
	{ ip_header_checksum_V_empty_n sc_in sc_logic 1 signal 5 } 
	{ ip_header_checksum_V_read sc_out sc_logic 1 signal 5 } 
	{ arpTableReplay_V_TVALID sc_in sc_logic 1 invld 0 } 
	{ dataOut_TREADY sc_in sc_logic 1 outacc 4 } 
	{ arpTableReplay_V_TDATA sc_in sc_lv 56 signal 0 } 
	{ arpTableReplay_V_TREADY sc_out sc_logic 1 inacc 0 } 
	{ myMacAddress_V sc_in sc_lv 48 signal 1 } 
	{ dataOut_TDATA sc_out sc_lv 512 signal 2 } 
	{ dataOut_TVALID sc_out sc_logic 1 outvld 4 } 
	{ dataOut_TKEEP sc_out sc_lv 64 signal 3 } 
	{ dataOut_TLAST sc_out sc_lv 1 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "no_ip_header_out_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "no_ip_header_out_V", "role": "dout" }} , 
 	{ "name": "no_ip_header_out_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "no_ip_header_out_V", "role": "empty_n" }} , 
 	{ "name": "no_ip_header_out_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "no_ip_header_out_V", "role": "read" }} , 
 	{ "name": "ip_header_checksum_V_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":577, "type": "signal", "bundle":{"name": "ip_header_checksum_V", "role": "dout" }} , 
 	{ "name": "ip_header_checksum_V_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ip_header_checksum_V", "role": "empty_n" }} , 
 	{ "name": "ip_header_checksum_V_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "ip_header_checksum_V", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3"],
		...
		"Port" : [
			...
			{"Name" : "ip_header_checksum_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
					{"Name" : "ip_header_checksum_V_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "no_ip_header_out_V", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	arpTableReplay_V { axis {  { arpTableReplay_V_TVALID in_vld 0 1 }  { arpTableReplay_V_TDATA in_data 0 56 }  { arpTableReplay_V_TREADY in_acc 1 1 } } }
	...
	ip_header_checksum_V { ap_fifo {  { ip_header_checksum_V_dout fifo_data 0 577 }  { ip_header_checksum_V_empty_n fifo_status 0 1 }  { ip_header_checksum_V_read fifo_update 1 1 } } }
	no_ip_header_out_V { ap_fifo {  { no_ip_header_out_V_dout fifo_data 0 577 }  { no_ip_header_out_V_empty_n fifo_status 0 1 }  { no_ip_header_out_V_read fifo_update 1 1 } } }
}
