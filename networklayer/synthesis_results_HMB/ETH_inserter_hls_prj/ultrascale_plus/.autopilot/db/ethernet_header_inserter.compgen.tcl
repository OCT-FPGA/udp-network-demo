...
# FIFO definition: 
set ID 30
set FifoName ethernet_header_inserter_fifo_w1024_d16_A
set InstName ip_header_out_U
...
set ID 31
set FifoName ethernet_header_inserter_fifo_w1024_d16_A
set InstName no_ip_header_out_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 16
...
set ID 32
set FifoName ethernet_header_inserter_fifo_w1024_d16_A
set InstName ip_header_checksum_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 16
...
# FIFO definition: 
set ID 33
set FifoName ethernet_header_inserter_start_for_compute_and_insert_ip_checksum_U0
set InstName start_for_compute_and_insert_ip_checksum_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 42 \
    name arpTableReplay_V \
    reset_level 0 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { arpTableReplay_V_TDATA { I 128 vector } arpTableReplay_V_TVALID { I 1 bit } arpTableReplay_V_TREADY { O 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'arpTableReplay_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 43 \
    name arpTableRequest_V \
    reset_level 0 \
    sync_rst true \
    corename {} \
    metadata {  } \
    op interface \
    ports { arpTableRequest_V_TDATA { O 32 vector } arpTableRequest_V_TVALID { O 1 bit } arpTableRequest_V_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'arpTableRequest_V'"
}
}
