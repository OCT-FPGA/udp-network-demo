...
# FIFO definition:
set ID 20
set FifoName fifo_w577_d16_A
set InstName ip_header_out_V_U
...
set ID 21
set FifoName fifo_w577_d16_A
set InstName no_ip_header_out_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 22
set FifoName fifo_w577_d16_A
set InstName ip_header_checksum_V_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 23
set FifoName start_for_computebkb
set InstName start_for_computebkb_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpTableReplay_V_TDATA { I 56 vector } arpTableReplay_V_TVALID { I 1 bit } arpTableReplay_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpTableRequest_V_V_TDATA { O 32 vector } arpTableRequest_V_V_TVALID { O 1 bit } arpTableRequest_V_V_TREADY { I 1 bit } } \
} "
} else {
