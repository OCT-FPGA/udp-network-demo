...
set sdx_kernel_name "ethernet_header_inserter"
set sdx_kernel_type ""
...
set Interfaces {
    ...
    arpTableRequest_V_V {
        type "axi4stream"
        mode "master"
        port_prefix "arpTableRequest_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
    ...
    ap_clk {
        ...
        buses "dataIn dataOut arpTableReplay_V arpTableRequest_V_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.1 machine 64 combinational 0 latency 8 II x}
