...
set C_modelArgList {
	...
	{ arpTable_macAddress int 64 regular {axi_slave 2}  }
	{ arpTable_ipAddress int 32 regular {axi_slave 1}  }
	{ arpTable_valid int 8 regular {axi_slave 2}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "arpDataIn_V_data_V", "interface" : "axis", "bitwidth" : 512, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "arpTable_macAddress", "interface" : "axi_slave", "bundle":"s_axilite","type":"ap_memory","bitwidth" : 64, "direction" : "READWRITE", "offset" : {"in":2048, "out":2048}, "offset_end" : {"in":4095, "out":4095}} , 
 	{ "Name" : "arpTable_ipAddress", "interface" : "axi_slave", "bundle":"s_axilite","type":"ap_memory","bitwidth" : 32, "direction" : "WRITEONLY", "offset" : {"out":1024}, "offset_end" : {"out":2047}} , 
 	{ "Name" : "arpTable_valid", "interface" : "axi_slave", "bundle":"s_axilite","type":"ap_memory","bitwidth" : 8, "direction" : "READWRITE", "offset" : {"in":256, "out":256}, "offset_end" : {"in":511, "out":511}} , 
...
set portList { 
	...
	{ macIpEncode_req_V_TDATA sc_in sc_lv 32 signal 4 } 
	...
	{ macIpEncode_rsp_V_TDATA sc_out sc_lv 128 signal 9 } 
	...
	{ macIpEncode_req_V_TVALID sc_in sc_logic 1 invld 4 } 
	{ macIpEncode_req_V_TREADY sc_out sc_logic 1 inacc 4 } 
	{ macIpEncode_rsp_V_TVALID sc_out sc_logic 1 outvld 9 } 
	{ macIpEncode_rsp_V_TREADY sc_in sc_logic 1 outacc 9 } 
...
set NewPortList {[ 
	{ "name": "s_axi_s_axilite_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "s_axilite", "role": "AWADDR" },"address":[{"name":"arp_scan","role":"data","value":"16"},{"name":"arpTable_valid","role":"data","value":"256"},{"name":"arpTable_macAddress","role":"data","value":"2048"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "6", "11", "16", "17", "18", "19", "20", "21", "22", "23", "24"],
		"CDFG" : "arp_server",
		...
		"Port" : [
			...
			{"Name" : "macIpEncode_req_V", "Type" : "Axis", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "genARPDiscovery_U0", "Port" : "macIpEncode_req_V"}]},
			...
			{"Name" : "macIpEncode_rsp_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "genARPDiscovery_U0", "Port" : "macIpEncode_rsp_V"}]},
			...
			{"Name" : "myMacAddress", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "arp_pkg_sender_U0", "Port" : "myMacAddress"}]},
			{"Name" : "myIpAddress", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					...
					{"ID" : "11", "SubInstance" : "arp_pkg_sender_U0", "Port" : "myIpAddress"}]},
			{"Name" : "gatewayIP", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "arp_pkg_sender_U0", "Port" : "gatewayIP"},
					{"ID" : "2", "SubInstance" : "entry_proc_U0", "Port" : "gatewayIP"}]},
			{"Name" : "networkMask", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "11", "SubInstance" : "arp_pkg_sender_U0", "Port" : "networkMask"},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.genARPDiscovery_U0", "Parent" : "0", "Child" : ["4", "5"],
		...
		"Port" : [
			...
			{"Name" : "ip_lsb_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "time_counter", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "macIpEncode_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "16", "DependentChan" : "19", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "macIpEncode_i_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "macIpEncode_rsp_i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "16", "DependentChan" : "20", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "macIpEncode_rsp_i_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arp_scan_1d_V", "Type" : "OVld", "Direction" : "IO"}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.genARPDiscovery_U0.regslice_both_macIpEncode_req_V_U", "Parent" : "3"},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.genARPDiscovery_U0.regslice_both_macIpEncode_rsp_V_U", "Parent" : "3"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arp_pkg_receiver_U0", "Parent" : "0", "Child" : ["7", "8", "9", "10"],
		...
		"Port" : [
			...
			{"Name" : "arpDataIn_V_last_V", "Type" : "Axis", "Direction" : "I"},
			{"Name" : "myIpAddress", "Type" : "None", "Direction" : "I"},
			{"Name" : "myIpAddress_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "16", "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "myIpAddress_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "wordCount_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "arpReplyFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "11", "DependentChan" : "22", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "arpReplyFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arpTableInsertFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "16", "DependentChan" : "23", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arp_pkg_sender_U0", "Parent" : "0", "Child" : ["12", "13", "14", "15"],
		...
		"Port" : [
			...
			{"Name" : "networkMask", "Type" : "None", "Direction" : "I"},
			{"Name" : "aps_fsmState", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "arpReplyFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "22", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "arpReplyFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "replyMeta_srcMac_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "replyMeta_ethType_V", "Type" : "OVld", "Direction" : "IO"},
			...
			{"Name" : "replyMeta_hwAddrSrc_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "replyMeta_protoAddrSrc_V", "Type" : "OVld", "Direction" : "IO"},
			{"Name" : "arpRequestFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "16", "DependentChan" : "24", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arp_table_U0", "Parent" : "0",
		...
		"Port" : [
			...
			{"Name" : "arpTable_ipAddress", "Type" : "Memory", "Direction" : "O"},
			{"Name" : "arpTable_valid", "Type" : "Memory", "Direction" : "IO"},
			{"Name" : "myIpAddress", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "21", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "myIpAddress_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "p_read", "Type" : "None", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "17", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "p_read1", "Type" : "None", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "18", "DependentChanDepth" : "2", "DependentChanType" : "1"},
			{"Name" : "arpTableInsertFifo", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "6", "DependentChan" : "23", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "arpTableInsertFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "macIpEncode_i", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "3", "DependentChan" : "19", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "macIpEncode_i_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "arpRequestFifo", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "11", "DependentChan" : "24", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "arpRequestFifo_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "macIpEncode_rsp_i", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "20", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "macIpEncode_rsp_i_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.gatewayIP_c_channel_U", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.networkMask_c_channel_U", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.macIpEncode_i_U", "Parent" : "0"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.macIpEncode_rsp_i_U", "Parent" : "0"},
	{"ID" : "21", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.myIpAddress_c_U", "Parent" : "0"},
	{"ID" : "22", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arpReplyFifo_U", "Parent" : "0"},
	{"ID" : "23", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arpTableInsertFifo_U", "Parent" : "0"},
	{"ID" : "24", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.arpRequestFifo_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	macIpEncode_req_V { axis {  { macIpEncode_req_V_TDATA in_data 0 32 }  { macIpEncode_req_V_TVALID in_vld 0 1 }  { macIpEncode_req_V_TREADY in_acc 1 1 } } }
	...
	macIpEncode_rsp_V { axis {  { macIpEncode_rsp_V_TDATA out_data 1 128 }  { macIpEncode_rsp_V_TVALID out_vld 1 1 }  { macIpEncode_rsp_V_TREADY out_acc 0 1 } } }
