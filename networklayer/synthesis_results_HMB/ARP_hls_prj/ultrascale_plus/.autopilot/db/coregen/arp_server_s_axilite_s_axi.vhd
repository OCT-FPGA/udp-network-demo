...
architecture behave of arp_server_s_axilite_s_axi is
    ...
    signal int_arpTable_macAddress_be0 : UNSIGNED(7 downto 0);
    signal int_arpTable_macAddress_d0 : UNSIGNED(63 downto 0);
    signal int_arpTable_macAddress_q0 : UNSIGNED(63 downto 0);
    ...
    signal int_arpTable_macAddress_be1 : UNSIGNED(7 downto 0);
    signal int_arpTable_macAddress_d1 : UNSIGNED(63 downto 0);
    signal int_arpTable_macAddress_q1 : UNSIGNED(63 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_arpTable_valid_d0 <= UNSIGNED(arpTable_valid_d0) & UNSIGNED(arpTable_valid_d0) & UNSIGNED(arpTable_valid_d0) & UNSIGNED(arpTable_valid_d0);
    arpTable_valid_q0    <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_arpTable_valid_q0, TO_INTEGER(int_arpTable_valid_shift0) * 8)(7 downto 0));
    ...
    int_arpTable_macAddress_be0 <= RESIZE(UNSIGNED(arpTable_macAddress_we0), 8);
    int_arpTable_macAddress_d0 <= RESIZE(UNSIGNED(arpTable_macAddress_d0), 64);
    arpTable_macAddress_q0 <= STD_LOGIC_VECTOR(RESIZE(int_arpTable_macAddress_q0, 64));
    ...
    int_arpTable_macAddress_be1 <= SHIFT_LEFT(RESIZE(UNSIGNED(WSTRB), 8), TO_INTEGER(waddr(2 downto 2)) * 4) when int_arpTable_macAddress_we1 = '1' else (others=>'0');
    int_arpTable_macAddress_d1 <= RESIZE(UNSIGNED(WDATA) & UNSIGNED(WDATA), 64);
