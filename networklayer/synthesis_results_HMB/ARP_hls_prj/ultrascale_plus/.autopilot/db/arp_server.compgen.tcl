...
# FIFO definition: 
set ID 47
set FifoName arp_server_fifo_w32_d2_S
set InstName gatewayIP_c_channel_U
...
set ID 48
set FifoName arp_server_fifo_w32_d2_S
set InstName networkMask_c_channel_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 2
...
# FIFO definition: 
set ID 49
set FifoName arp_server_fifo_w32_d4_S
set InstName macIpEncode_i_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
# FIFO definition: 
set ID 50
set FifoName arp_server_fifo_w128_d4_S
set InstName macIpEncode_rsp_i_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
# FIFO definition: 
set ID 52
set FifoName arp_server_fifo_w256_d4_S
set InstName arpReplyFifo_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set DualClock 0
set Depth 4
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { macIpEncode_req_V_TDATA { I 32 vector } macIpEncode_req_V_TVALID { I 1 bit } macIpEncode_req_V_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { macIpEncode_rsp_V_TDATA { O 128 vector } macIpEncode_rsp_V_TVALID { O 1 bit } macIpEncode_rsp_V_TREADY { I 1 bit } } \
} "
} else {
