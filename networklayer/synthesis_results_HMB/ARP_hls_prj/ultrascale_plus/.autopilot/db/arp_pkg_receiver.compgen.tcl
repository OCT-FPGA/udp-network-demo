...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpDataIn_TVALID { I 1 bit } arpDataIn_TDATA { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpDataIn_TREADY { O 1 bit } arpDataIn_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpReplyFifo_V_din { O 192 vector } arpReplyFifo_V_full_n { I 1 bit } arpReplyFifo_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpTableInsertFifo_V_din { O 81 vector } arpTableInsertFifo_V_full_n { I 1 bit } arpTableInsertFifo_V_write { O 1 bit } } \
} "
}
