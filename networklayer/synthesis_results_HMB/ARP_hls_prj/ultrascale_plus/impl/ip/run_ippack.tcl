...
set sdx_kernel_name "arp_server"
set sdx_kernel_type ""
...
set Interfaces {
    s_axi_s_axilite {
        ...
        registers {{0x1500 arp_scan_V_i W 0x0 "Data signal of arp_scan_V_i" {{0 1 arp_scan_V_i W 0 "Bit 0 to 0 Data signal of arp_scan_V_i"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1508 arp_scan_V_o R 0x0 "Data signal of arp_scan_V_o" {{0 1 arp_scan_V_o R 0 "Bit 0 to 0 Data signal of arp_scan_V_o"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x150c arp_scan_V_o_ctrl R 0x0 "Control signal of arp_scan_V_o" {{0 1 arp_scan_V_o_ap_vld R 0 "Control signal arp_scan_V_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "arpTable_macAddress_V {base_address 2048 range 2048} arpTable_ipAddress_V {base_address 4096 range 1024} arpTable_valid_V {base_address 5120 range 256}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_s_axilite arpDataIn macIpEncode_req_V_V arpDataOut macIpEncode_rsp_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    macIpEncode_req_V_V {
        type "axi4stream"
        mode "slave"
        port_prefix "macIpEncode_req_V_V"
        has_tready "1"
        ports {
            TDATA 32
        }
...
## System Info
set user_parameters_list {clk_period 3.1 machine 64 combinational 0 latency 7 II x}
