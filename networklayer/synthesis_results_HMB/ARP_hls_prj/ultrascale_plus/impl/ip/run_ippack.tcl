...
set Version     "1.0"
set DisplayName "Arp_server"
set Revision    "2111031422"
...
set xo_kernel_name "arp_server"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/ubuntu/xup_vitis_network_example/NetLayers/100G-fpga-network-stack-core/synthesis_results_HMB/ARP_hls_prj/ultrascale_plus"
set debug_dir "/home/ubuntu/xup_vitis_network_example/NetLayers/100G-fpga-network-stack-core/synthesis_results_HMB/ARP_hls_prj/ultrascale_plus/.debug"
set xo_hls_files_dir ""
set hdl_module_list {arp_server_regslice_both
...
set Interfaces {
    s_axi_s_axilite {
        ...
        registers {{0x10 arp_scan_i W 0x0 "Data signal of arp_scan_i" {{0 1 arp_scan_i W 0 "Bit 0 to 0 of arp_scan_i"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 arp_scan_o R 0x0 "Data signal of arp_scan_o" {{0 1 arp_scan_o R 0 "Bit 0 to 0 of arp_scan_o"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x1c arp_scan_o_ctrl R 0x0 "Control signal of arp_scan_o" {{0 1 arp_scan_o_ap_vld R 0 "Control signal arp_scan_o_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "arpTable_valid {base_address 256 range 256} arpTable_ipAddress {base_address 1024 range 1024} arpTable_macAddress {base_address 2048 range 2048}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
    ...
    ap_clk {
        ...
        buses "s_axi_s_axilite arpDataIn macIpEncode_req_V arpDataOut macIpEncode_rsp_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 3.1 machine 64 combinational 0 latency 4 II x}
