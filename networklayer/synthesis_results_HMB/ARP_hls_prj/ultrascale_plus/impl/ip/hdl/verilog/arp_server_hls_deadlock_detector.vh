    ...
    reg ap_done_reg_0;// for module arp_table_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= arp_table_U0.ap_done & ~arp_table_U0.ap_continue;
        end
    end
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~genARPDiscovery_U0.macIpEncode_i_blk_n) | (~genARPDiscovery_U0.macIpEncode_rsp_i_blk_n);
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~arp_pkg_receiver_U0.myIpAddress_c_blk_n) | (~arp_pkg_receiver_U0.arpTableInsertFifo_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~arp_pkg_receiver_U0.arpReplyFifo_blk_n);
    ...
    arp_server_hls_deadlock_detect_unit #(4, 2, 2, 2) arp_server_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~arp_pkg_sender_U0.arpReplyFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~arp_pkg_sender_U0.arpRequestFifo_blk_n);
    ...
    arp_server_hls_deadlock_detect_unit #(4, 3, 3, 3) arp_server_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~arp_table_U0.myIpAddress_blk_n) | (~arp_table_U0.arpTableInsertFifo_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~arp_table_U0.macIpEncode_i_blk_n) | (~arp_table_U0.macIpEncode_rsp_i_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~arp_table_U0.arpRequestFifo_blk_n);
