...
reg   [0:0] tmp_i_112_reg_324_pp0_iter1_reg;
...
wire   [511:0] tmp_27_fu_251_p1;
reg   [511:0] tmp_27_reg_328;
reg   [63:0] tmp_28_reg_333;
wire   [0:0] currWord_last_V_fu_265_p3;
reg   [0:0] currWord_last_V_reg_338;
wire   [15:0] trunc_ln145_1_fu_157_p1;
...
always @ (posedge ap_clk) begin
    if (((tmp_i_112_nbreadreq_fu_112_p3 == 1'd1) & (repd_state == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        currWord_last_V_reg_338 <= ureDataPayload_dout[32'd576];
        tmp_27_reg_328 <= tmp_27_fu_251_p1;
        tmp_28_reg_333 <= {{ureDataPayload_dout[575:512]}};
    end
end
...
always @ (*) begin
    ap_condition_179 = ((tmp_i_112_nbreadreq_fu_112_p3 == 1'd1) & (repd_state == 1'd1) & (currWord_last_V_fu_265_p3 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op37_read_state1 = ((tmp_i_112_nbreadreq_fu_112_p3 == 1'd1) & (repd_state == 1'd1));
end

always @ (*) begin
    ap_predicate_op53_write_state2 = ((response_drop_V_load_reg_317 == 1'd0) & (tmp_i_112_reg_324 == 1'd1) & (repd_state_load_reg_313 == 1'd1));
end

always @ (*) begin
    ap_predicate_op54_write_state3 = ((response_drop_V_load_reg_317_pp0_iter1_reg == 1'd0) & (tmp_i_112_reg_324_pp0_iter1_reg == 1'd1) & (repd_state_load_reg_313_pp0_iter1_reg == 1'd1));
end

assign currWord_last_V_fu_265_p3 = ureDataPayload_dout[32'd576];

assign tmp_27_fu_251_p1 = ureDataPayload_dout[511:0];

assign tmp_i_112_nbreadreq_fu_112_p3 = ureDataPayload_empty_n;

assign tmp_i_nbreadreq_fu_98_p3 = rthDropFifo_empty_n;

assign trunc_ln145_1_fu_157_p1 = rthDropFifo_dout[15:0];
