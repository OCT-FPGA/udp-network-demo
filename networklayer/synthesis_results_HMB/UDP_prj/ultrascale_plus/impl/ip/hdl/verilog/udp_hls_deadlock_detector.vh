    ...
    reg ap_done_reg_0;// for module TableHandler_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_0 <= 'b0;
        end
        else begin
            ap_done_reg_0 <= TableHandler_U0.ap_done & ~TableHandler_U0.ap_continue;
        end
    end

reg [15:0] trans_in_cnt_0;// for process udpRxEngine_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
...
reg [15:0] trans_out_cnt_0;// for process udpRxEngine_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
...
reg [15:0] trans_in_cnt_1;// for process appGetMetaData_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
...
reg [15:0] trans_out_cnt_1;// for process appGetMetaData_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
    ...
    udp_hls_deadlock_detect_unit #(5, 0, 2, 2) udp_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~udpRxEngine_U0.ureMetaData_blk_n);
    ...
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~udpRxEngine_U0.ureDataPayload_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_rxEngPacketDropper_U0_U.if_full_n & udpRxEngine_U0.ap_start & ~udpRxEngine_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_rxEngPacketDropper_U0_U.if_read);
    ...
    udp_hls_deadlock_detect_unit #(5, 1, 4, 4) udp_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~TableHandler_U0.ureMetaData_blk_n);
    ...
    assign proc_1_data_FIFO_blk[1] = 1'b0 | (~TableHandler_U0.rthDropFifo_blk_n);
    ...
    assign proc_1_data_FIFO_blk[2] = 1'b0 | (~TableHandler_U0.agmdIdOut_blk_n);
    ...
    assign proc_1_data_FIFO_blk[3] = 1'b0 | (~TableHandler_U0.txthMetaData_blk_n);
    ...
    udp_hls_deadlock_detect_unit #(5, 2, 2, 2) udp_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~rxEngPacketDropper_U0.rthDropFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~rxEngPacketDropper_U0.ureDataPayload_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_rxEngPacketDropper_U0_U.if_empty_n & rxEngPacketDropper_U0.ap_idle & ~start_for_rxEngPacketDropper_U0_U.if_write);
    ...
    udp_hls_deadlock_detect_unit #(5, 3, 2, 2) udp_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~appGetMetaData_U0.agmdDataOut_blk_n) | (~appGetMetaData_U0.agmdpayloadLenOut_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_udpTxEngine_U0_U.if_full_n & appGetMetaData_U0.ap_start & ~appGetMetaData_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_udpTxEngine_U0_U.if_read);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~appGetMetaData_U0.agmdIdOut_blk_n);
    ...
    udp_hls_deadlock_detect_unit #(5, 4, 2, 2) udp_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~udpTxEngine_U0.txthMetaData_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~udpTxEngine_U0.agmdpayloadLenOut_blk_n) | (~udpTxEngine_U0.agmdDataOut_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0 | (~start_for_udpTxEngine_U0_U.if_empty_n & udpTxEngine_U0.ap_idle & ~start_for_udpTxEngine_U0_U.if_write);
