...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rxUdpDataIn_TVALID { I 1 bit } rxUdpDataIn_TDATA { I 512 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { rxUdpDataIn_TREADY { O 1 bit } rxUdpDataIn_TLAST { I 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ureMetaData_V_din { O 97 vector } ureMetaData_V_full_n { I 1 bit } ureMetaData_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ureDataPayload_V_din { O 577 vector } ureDataPayload_V_full_n { I 1 bit } ureDataPayload_V_write { O 1 bit } } \
} "
}
