set SynModuleInfo {
  ...
  {SRCNAME packet_handler MODELNAME packet_handler RTLNAME packet_handler IS_TOP 1
    SUBMODULES {
      {MODELNAME packet_handler_fifo_w1024_d16_A RTLNAME packet_handler_fifo_w1024_d16_A BINDTYPE storage TYPE fifo IMPL memory ALLOW_PRAGMA 1 INSTNAME eth_level_pkt_U}
      {MODELNAME packet_handler_start_for_ethernet_remover_U0 RTLNAME packet_handler_start_for_ethernet_remover_U0 BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME start_for_ethernet_remover_U0_U}
    }
  }
}
