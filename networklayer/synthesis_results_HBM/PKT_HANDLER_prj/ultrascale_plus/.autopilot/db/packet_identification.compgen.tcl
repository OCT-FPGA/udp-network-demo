...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_TVALID { I 1 bit } s_axis_TREADY { O 1 bit } s_axis_TDEST { I 3 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { eth_level_pkt_din { O 1024 vector } eth_level_pkt_num_data_valid { I 5 vector } eth_level_pkt_fifo_cap { I 5 vector } eth_level_pkt_full_n { I 1 bit } eth_level_pkt_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 7
set RegSliceName packet_handler_regslice_both
set RegSliceInstName packet_handler_regslice_both_U
set CoreName ap_simcore_packet_handler_regslice_both
