set SynModuleInfo {
  ...
  {SRCNAME arp_server MODELNAME arp_server RTLNAME arp_server IS_TOP 1
    SUBMODULES {
      {MODELNAME arp_server_fifo_w48_d3_S RTLNAME arp_server_fifo_w48_d3_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME arp_server_fifo_w32_d3_S RTLNAME arp_server_fifo_w32_d3_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      ...
      {MODELNAME arp_server_start_for_arp_pkg_sender_U0 RTLNAME arp_server_start_for_arp_pkg_sender_U0 BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
