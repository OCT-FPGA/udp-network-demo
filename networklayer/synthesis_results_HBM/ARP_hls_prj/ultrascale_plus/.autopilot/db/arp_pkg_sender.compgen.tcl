...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpReplyFifo_dout { I 256 vector } arpReplyFifo_num_data_valid { I 3 vector } arpReplyFifo_fifo_cap { I 3 vector } arpReplyFifo_empty_n { I 1 bit } arpReplyFifo_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { arpRequestFifo_dout { I 32 vector } arpRequestFifo_num_data_valid { I 3 vector } arpRequestFifo_fifo_cap { I 3 vector } arpRequestFifo_empty_n { I 1 bit } arpRequestFifo_read { O 1 bit } } \
} "
}
