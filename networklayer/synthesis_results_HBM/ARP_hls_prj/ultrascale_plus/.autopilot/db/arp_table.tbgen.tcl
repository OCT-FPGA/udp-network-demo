...
set portList { 
	...
	{ networkMask_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ networkMask_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ gatewayIP_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ gatewayIP_fifo_cap sc_in sc_lv 3 signal 4 } 
	...
	{ myIpAddress_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ myIpAddress_fifo_cap sc_in sc_lv 2 signal 3 } 
	...
	{ macIpEncode_i_num_data_valid sc_in sc_lv 3 signal 7 } 
	{ macIpEncode_i_fifo_cap sc_in sc_lv 3 signal 7 } 
	...
	{ arpTableInsertFifo_num_data_valid sc_in sc_lv 3 signal 6 } 
	{ arpTableInsertFifo_fifo_cap sc_in sc_lv 3 signal 6 } 
	...
	{ macIpEncode_rsp_i_num_data_valid sc_in sc_lv 3 signal 9 } 
	{ macIpEncode_rsp_i_fifo_cap sc_in sc_lv 3 signal 9 } 
	...
	{ arpRequestFifo_num_data_valid sc_in sc_lv 3 signal 8 } 
	{ arpRequestFifo_fifo_cap sc_in sc_lv 3 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "macIpEncode_i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "macIpEncode_i", "role": "num_data_valid" }} , 
 	{ "name": "macIpEncode_i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "macIpEncode_i", "role": "fifo_cap" }} , 
 	...
 	{ "name": "macIpEncode_rsp_i_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "macIpEncode_rsp_i", "role": "num_data_valid" }} , 
 	{ "name": "macIpEncode_rsp_i_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "macIpEncode_rsp_i", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	...
	arpTableInsertFifo { ap_fifo {  { arpTableInsertFifo_dout fifo_port_we 0 128 }  { arpTableInsertFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { arpTableInsertFifo_fifo_cap fifo_update 0 3 }  { arpTableInsertFifo_empty_n fifo_status 0 1 }  { arpTableInsertFifo_read fifo_data 1 1 } } }
	macIpEncode_i { ap_fifo {  { macIpEncode_i_dout fifo_port_we 0 32 }  { macIpEncode_i_num_data_valid fifo_status_num_data_valid 0 3 }  { macIpEncode_i_fifo_cap fifo_update 0 3 }  { macIpEncode_i_empty_n fifo_status 0 1 }  { macIpEncode_i_read fifo_data 1 1 } } }
	arpRequestFifo { ap_fifo {  { arpRequestFifo_din fifo_port_we 1 32 }  { arpRequestFifo_num_data_valid fifo_status_num_data_valid 0 3 }  { arpRequestFifo_fifo_cap fifo_update 0 3 }  { arpRequestFifo_full_n fifo_status 0 1 }  { arpRequestFifo_write fifo_data 1 1 } } }
	macIpEncode_rsp_i { ap_fifo {  { macIpEncode_rsp_i_din fifo_port_we 1 128 }  { macIpEncode_rsp_i_num_data_valid fifo_status_num_data_valid 0 3 }  { macIpEncode_rsp_i_fifo_cap fifo_update 0 3 }  { macIpEncode_rsp_i_full_n fifo_status 0 1 }  { macIpEncode_rsp_i_write fifo_data 1 1 } } }
}
