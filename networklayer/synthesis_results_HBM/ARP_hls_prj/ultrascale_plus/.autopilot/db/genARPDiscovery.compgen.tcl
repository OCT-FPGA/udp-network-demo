...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { macIpEncode_req_TVALID { I 1 bit } macIpEncode_req_TDATA { I 32 vector } macIpEncode_req_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { macIpEncode_rsp_TREADY { I 1 bit } macIpEncode_rsp_TDATA { O 128 vector } macIpEncode_rsp_TVALID { O 1 bit } } \
} "
} else {
