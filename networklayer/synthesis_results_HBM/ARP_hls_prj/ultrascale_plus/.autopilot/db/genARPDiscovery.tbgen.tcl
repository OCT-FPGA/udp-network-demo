...
set portList { 
	...
	{ macIpEncode_req_TVALID sc_in sc_logic 1 invld 0 } 
	{ macIpEncode_rsp_i_dout sc_in sc_lv 128 signal 5 } 
	{ macIpEncode_rsp_i_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ macIpEncode_rsp_i_fifo_cap sc_in sc_lv 3 signal 5 } 
	...
	{ macIpEncode_i_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ macIpEncode_i_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ macIpEncode_i_full_n sc_in sc_logic 1 signal 4 } 
	{ macIpEncode_i_write sc_out sc_logic 1 signal 4 } 
	{ macIpEncode_rsp_TREADY sc_in sc_logic 1 outacc 1 } 
	{ macIpEncode_req_TDATA sc_in sc_lv 32 signal 0 } 
	{ macIpEncode_req_TREADY sc_out sc_logic 1 inacc 0 } 
	{ macIpEncode_rsp_TDATA sc_out sc_lv 128 signal 1 } 
	{ macIpEncode_rsp_TVALID sc_out sc_logic 1 outvld 1 } 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_macIpEncode_req_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.regslice_both_macIpEncode_rsp_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	macIpEncode_req { axis {  { macIpEncode_req_TVALID in_vld 0 1 }  { macIpEncode_req_TDATA in_data 0 32 }  { macIpEncode_req_TREADY in_acc 1 1 } } }
	macIpEncode_rsp { axis {  { macIpEncode_rsp_TREADY out_acc 0 1 }  { macIpEncode_rsp_TDATA out_data 1 128 }  { macIpEncode_rsp_TVALID out_vld 1 1 } } }
	...
	macIpEncode_i { ap_fifo {  { macIpEncode_i_din fifo_port_we 1 32 }  { macIpEncode_i_num_data_valid fifo_status_num_data_valid 0 3 }  { macIpEncode_i_fifo_cap fifo_update 0 3 }  { macIpEncode_i_full_n fifo_status 0 1 }  { macIpEncode_i_write fifo_data 1 1 } } }
	macIpEncode_rsp_i { ap_fifo {  { macIpEncode_rsp_i_dout fifo_port_we 0 128 }  { macIpEncode_rsp_i_num_data_valid fifo_status_num_data_valid 0 3 }  { macIpEncode_rsp_i_fifo_cap fifo_update 0 3 }  { macIpEncode_rsp_i_empty_n fifo_status 0 1 }  { macIpEncode_rsp_i_read fifo_data 1 1 } } }
}
