...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    arp_server_hls_deadlock_detect_unit #(5, 0, 2, 2) arp_server_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~entry_proc_U0.myMacAddress_c_blk_n) | (~entry_proc_U0.gatewayIP_c12_blk_n) | (~entry_proc_U0.networkMask_c13_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_arp_pkg_sender_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_arp_pkg_sender_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0;
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~entry_proc_U0.gatewayIP_c_blk_n) | (~entry_proc_U0.networkMask_c_blk_n);
    ...
    // Process: genARPDiscovery_U0
    arp_server_hls_deadlock_detect_unit #(5, 1, 1, 1) arp_server_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~genARPDiscovery_U0.macIpEncode_i_blk_n) | (~genARPDiscovery_U0.macIpEncode_rsp_i_blk_n);
    ...
    assign in_chan_dep_vld_vec_1[0] = dep_chan_vld_4_1;
    assign in_chan_dep_data_vec_1[4 : 0] = dep_chan_data_4_1;
    assign token_in_vec_1[0] = token_4_1;
    ...
    // Process: arp_pkg_receiver_U0
    arp_server_hls_deadlock_detect_unit #(5, 2, 2, 2) arp_server_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~arp_pkg_receiver_U0.myIpAddress_c_blk_n) | (~arp_pkg_receiver_U0.arpTableInsertFifo_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~arp_pkg_receiver_U0.myIpAddress_c11_blk_n) | (~arp_pkg_receiver_U0.arpReplyFifo_blk_n);
    ...
    // Process: arp_pkg_sender_U0
    arp_server_hls_deadlock_detect_unit #(5, 3, 3, 3) arp_server_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~arp_pkg_sender_U0.myMacAddress_blk_n) | (~arp_pkg_sender_U0.gatewayIP_blk_n) | (~arp_pkg_sender_U0.networkMask_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_arp_pkg_sender_U0_U.if_empty_n & arp_pkg_sender_U0.ap_idle & ~start_for_arp_pkg_sender_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~arp_pkg_sender_U0.myIpAddress_blk_n) | (~arp_pkg_sender_U0.arpReplyFifo_blk_n);
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~arp_pkg_sender_U0.arpRequestFifo_blk_n);
    ...
    arp_server_hls_deadlock_detect_unit #(5, 4, 4, 4) arp_server_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~arp_table_U0.myIpAddress_blk_n) | (~arp_table_U0.arpTableInsertFifo_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~arp_table_U0.gatewayIP_blk_n) | (~arp_table_U0.networkMask_blk_n);
    ...
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~arp_table_U0.macIpEncode_i_blk_n) | (~arp_table_U0.macIpEncode_rsp_i_blk_n);
    ...
    assign proc_4_data_FIFO_blk[3] = 1'b0 | (~arp_table_U0.arpRequestFifo_blk_n);
