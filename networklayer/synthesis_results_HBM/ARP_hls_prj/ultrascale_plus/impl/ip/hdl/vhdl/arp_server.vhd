...
architecture behav of arp_server is 
    ...
    signal gatewayIP_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal gatewayIP_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal gatewayIP_c12_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal gatewayIP_c12_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal networkMask_c_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal networkMask_c_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal networkMask_c13_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal networkMask_c13_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal macIpEncode_i_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal macIpEncode_i_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal macIpEncode_rsp_i_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal macIpEncode_rsp_i_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal myIpAddress_c11_num_data_valid : STD_LOGIC_VECTOR (1 downto 0);
    signal myIpAddress_c11_fifo_cap : STD_LOGIC_VECTOR (1 downto 0);
    ...
    signal arpReplyFifo_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal arpReplyFifo_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal arpRequestFifo_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal arpRequestFifo_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    port (
        ...
        gatewayIP_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        gatewayIP_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        gatewayIP_c_full_n : IN STD_LOGIC;
        gatewayIP_c_write : OUT STD_LOGIC;
        gatewayIP_c12_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        gatewayIP_c12_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        gatewayIP_c12_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        gatewayIP_c12_full_n : IN STD_LOGIC;
        gatewayIP_c12_write : OUT STD_LOGIC;
        networkMask : IN STD_LOGIC_VECTOR (31 downto 0);
        networkMask_c_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        networkMask_c_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        networkMask_c_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
        networkMask_c_full_n : IN STD_LOGIC;
        networkMask_c_write : OUT STD_LOGIC;
        networkMask_c13_din : OUT STD_LOGIC_VECTOR (31 downto 0);
        networkMask_c13_num_data_valid : IN STD_LOGIC_VECTOR (2 downto 0);
        networkMask_c13_fifo_cap : IN STD_LOGIC_VECTOR (2 downto 0);
