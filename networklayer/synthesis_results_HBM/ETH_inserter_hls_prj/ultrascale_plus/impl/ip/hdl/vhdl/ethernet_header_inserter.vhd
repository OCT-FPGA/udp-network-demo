...
architecture behav of ethernet_header_inserter is 
    ...
    "ethernet_header_inserter_ethernet_header_inserter,hls_ip_2023_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcu280-fsvh2892-2L-e,HLS_INPUT_CLOCK=3.100000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=2.815938,HLS_SYN_LAT=9,HLS_SYN_TPT=1,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=13968,HLS_SYN_LUT=7685,HLS_VERSION=2023_1}";
    ...
    signal ip_header_out_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal ip_header_out_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal no_ip_header_out_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal no_ip_header_out_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
    ...
    signal ip_header_checksum_num_data_valid : STD_LOGIC_VECTOR (4 downto 0);
    signal ip_header_checksum_fifo_cap : STD_LOGIC_VECTOR (4 downto 0);
