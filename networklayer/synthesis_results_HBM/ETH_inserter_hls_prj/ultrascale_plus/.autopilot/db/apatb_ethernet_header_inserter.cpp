...
extern "C"
void ethernet_header_inserter_hw_stub_wrapper(void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*, void*);

extern "C"
void apatb_ethernet_header_inserter_hw(void* __xlx_apatb_param_dataIn_V_data_V, void* __xlx_apatb_param_dataIn_V_keep_V, void* __xlx_apatb_param_dataIn_V_strb_V, void* __xlx_apatb_param_dataIn_V_last_V, void* __xlx_apatb_param_dataOut_V_data_V, void* __xlx_apatb_param_dataOut_V_keep_V, void* __xlx_apatb_param_dataOut_V_strb_V, void* __xlx_apatb_param_dataOut_V_last_V, void* __xlx_apatb_param_arpTableReplay, void* __xlx_apatb_param_arpTableRequest, void* __xlx_apatb_param_myMacAddress, void* __xlx_apatb_param_regSubNetMask, void* __xlx_apatb_param_regDefaultGateway)
{
  static hls::sim::Stream<hls::sim::Byte<64>> port0 {
    .width = 512,
    .name = "dataIn_V_data_V",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_dataIn_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_dataIn_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_dataIn_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_dataIn_V_data_V),
#endif
  };
  port0.param = (hls::stream<hls::sim::Byte<64>>*)__xlx_apatb_param_dataIn_V_data_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_dataIn_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_dataIn_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_dataIn_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_dataIn_V_keep_V),
#endif
  };
  port1.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_dataIn_V_keep_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_dataIn_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_dataIn_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_dataIn_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_dataIn_V_strb_V),
#endif
  };
  port2.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_dataIn_V_strb_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_dataIn_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_dataIn_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_dataIn_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_dataIn_V_last_V),
#endif
  };
  port3.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_dataIn_V_last_V;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dataOut_V_data_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_dataOut_V_data_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_dataOut_V_data_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_dataOut_V_data_V),
#endif
  };
  port4.param = (hls::stream<hls::sim::Byte<64>>*)__xlx_apatb_param_dataOut_V_data_V;
  port4.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dataOut_V_keep_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_dataOut_V_keep_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_dataOut_V_keep_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_dataOut_V_keep_V),
#endif
  };
  port5.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_dataOut_V_keep_V;
  port5.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dataOut_V_strb_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_dataOut_V_strb_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_dataOut_V_strb_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_dataOut_V_strb_V),
#endif
  };
  port6.param = (hls::stream<hls::sim::Byte<8>>*)__xlx_apatb_param_dataOut_V_strb_V;
  port6.hasWrite = true;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_dataOut_V_last_V),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_dataOut_V_last_V),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_dataOut_V_last_V),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_dataOut_V_last_V),
#endif
  };
  port7.param = (hls::stream<hls::sim::Byte<1>>*)__xlx_apatb_param_dataOut_V_last_V;
  port7.hasWrite = true;

  static hls::sim::Stream<hls::sim::Byte<16>> port8 {
    .width = 128,
    .name = "arpTableReplay",
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(WRAPC_STREAM_SIZE_IN_arpTableReplay),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVIN_arpTableReplay),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_IN_arpTableReplay),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_INGRESS_STATUS_arpTableReplay),
#endif
  };
  port8.param = (hls::stream<hls::sim::Byte<16>>*)__xlx_apatb_param_arpTableReplay;
...
#ifdef POST_CHECK
    .reader = new hls::sim::Reader(AUTOTB_TVOUT_PC_arpTableRequest),
#else
    .writer = new hls::sim::Writer(AUTOTB_TVOUT_arpTableRequest),
    .swriter = new hls::sim::Writer(WRAPC_STREAM_SIZE_OUT_arpTableRequest),
    .gwriter = new hls::sim::Writer(WRAPC_STREAM_EGRESS_STATUS_arpTableRequest),
#endif
  };
  port9.param = (hls::stream<hls::sim::Byte<4>>*)__xlx_apatb_param_arpTableRequest;
  port9.hasWrite = true;
  ...
  port10.param = __xlx_apatb_param_myMacAddress;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_regSubNetMask),
#endif
  };
  port11.param = __xlx_apatb_param_regSubNetMask;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_regDefaultGateway),
#endif
  };
  port12.param = __xlx_apatb_param_regDefaultGateway;
