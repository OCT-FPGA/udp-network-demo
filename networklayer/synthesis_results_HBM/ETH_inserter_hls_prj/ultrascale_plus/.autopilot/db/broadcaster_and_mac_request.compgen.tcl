...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpTableRequest_TREADY { I 1 bit } arpTableRequest_TDATA { O 32 vector } arpTableRequest_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ip_header_out_din { O 1024 vector } ip_header_out_num_data_valid { I 5 vector } ip_header_out_fifo_cap { I 5 vector } ip_header_out_full_n { I 1 bit } ip_header_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { no_ip_header_out_din { O 1024 vector } no_ip_header_out_num_data_valid { I 5 vector } no_ip_header_out_fifo_cap { I 5 vector } no_ip_header_out_full_n { I 1 bit } no_ip_header_out_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 12
set RegSliceName ethernet_header_inserter_regslice_both
set RegSliceInstName ethernet_header_inserter_regslice_both_U
set CoreName ap_simcore_ethernet_header_inserter_regslice_both
...
eval "::AESL_LIB_VIRTEX::xil_gen_regSlice { \
    name ${RegSliceName} \
    prefix ethernet_header_inserter_ \
    sliceTypeList 0\
}"
} else {
