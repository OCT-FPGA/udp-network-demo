...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { arpTableReplay_TVALID { I 1 bit } arpTableReplay_TDATA { I 128 vector } arpTableReplay_TREADY { O 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { dataOut_TREADY { I 1 bit } dataOut_TVALID { O 1 bit } dataOut_TLAST { O 1 vector } } \
} "
} else {
