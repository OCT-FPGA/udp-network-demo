set SynModuleInfo {
  ...
  {SRCNAME TableHandler MODELNAME TableHandler RTLNAME udp_TableHandler
    SUBMODULES {
      {MODELNAME udp_mux_1616_32_1_1 RTLNAME udp_mux_1616_32_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME udp_mux_1616_16_1_1 RTLNAME udp_mux_1616_16_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
      {MODELNAME udp_mux_1616_1_1_1 RTLNAME udp_mux_1616_1_1_1 BINDTYPE op TYPE mux IMPL auto LATENCY 0 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME udp MODELNAME udp RTLNAME udp IS_TOP 1
    SUBMODULES {
      {MODELNAME udp_fifo_w32_d3_S RTLNAME udp_fifo_w32_d3_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME udp_fifo_w16_d3_S RTLNAME udp_fifo_w16_d3_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      {MODELNAME udp_fifo_w1_d3_S RTLNAME udp_fifo_w1_d3_S BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
      ...
      {MODELNAME udp_start_for_TableHandler_U0 RTLNAME udp_start_for_TableHandler_U0 BINDTYPE storage TYPE fifo IMPL srl LATENCY -1 ALLOW_PRAGMA 1 INSTNAME {$InstName}}
