...
static AESL_FILE_HANDLER aesl_fh;
  ...
  if (wrapc_switch_file_token.good())
  {
    ...
    string AESL_token;
    string AESL_num;
long __xlx_apatb_param_rxUdpDataIn_stream_buf_final_size;
{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "txUdpDataOut");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "txUdpDataOut" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "DataOutApp");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "DataOutApp" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          ...
          while (AESL_token != "[[/transaction]]"){
            ...
            has_unknown_value |= RTLOutputCheckAndReplacement(AESL_token, "numberSockets");
          ...
          if (has_unknown_value) {
            cerr << "WARNING: [SIM 212-201] RTL produces unknown value 'x' or 'X' on port " 
                 << "numberSockets" << ", possible cause: There are uninitialized variables in the C design."
                 << endl; 
          }
...
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_0, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_0);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_0, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_0_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_0, end_str());
}

// print SocketTable_theirIP_1 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_1, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_1);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_1, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_1_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_1, end_str());
}

// print SocketTable_theirIP_2 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_2, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_2);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_2, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_2_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_2, end_str());
}

// print SocketTable_theirIP_3 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_3, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_3);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_3, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_3_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_3, end_str());
}

// print SocketTable_theirIP_4 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_4, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_4);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_4, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_4_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_4, end_str());
}

// print SocketTable_theirIP_5 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_5, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_5);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_5, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_5_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_5, end_str());
}

// print SocketTable_theirIP_6 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_6, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_6);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_6, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_6_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_6, end_str());
}

// print SocketTable_theirIP_7 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_7, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_7);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_7, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_7_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_7, end_str());
}

// print SocketTable_theirIP_8 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_8, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_8);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_8, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_8_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_8, end_str());
}

// print SocketTable_theirIP_9 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_9, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_9);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_9, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_9_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_9, end_str());
}

// print SocketTable_theirIP_10 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_10, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_10);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_10, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_10_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_10, end_str());
}

// print SocketTable_theirIP_11 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_11, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_11);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_11, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_11_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_11, end_str());
}

// print SocketTable_theirIP_12 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_12, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_12);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_12, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_12_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_12, end_str());
}

// print SocketTable_theirIP_13 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_13, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_13);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_13, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_13_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_13, end_str());
}

// print SocketTable_theirIP_14 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_14, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_14);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_14, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_14_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_14, end_str());
}

// print SocketTable_theirIP_15 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_15, begin_str(AESL_transaction));
{
    sc_bv<32> __xlx_tmp_lv = *((int*)__xlx_apatb_param_SocketTable_theirIP_15);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_15, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirIP_15_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirIP_15, end_str());
}

// print SocketTable_theirPort_0 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_0, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_0);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_0, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_0_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_0, end_str());
}

// print SocketTable_theirPort_1 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_1, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_1);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_1, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_1_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_1, end_str());
}

// print SocketTable_theirPort_2 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_2, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_2);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_2, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_2_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_2, end_str());
}

// print SocketTable_theirPort_3 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_3, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_3);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_3, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_3_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_3, end_str());
}

// print SocketTable_theirPort_4 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_4, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_4);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_4, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_4_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_4, end_str());
}

// print SocketTable_theirPort_5 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_5, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_5);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_5, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_5_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_5, end_str());
}

// print SocketTable_theirPort_6 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_6, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_6);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_6, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_6_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_6, end_str());
}

// print SocketTable_theirPort_7 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_7, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_7);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_7, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_7_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_7, end_str());
}

// print SocketTable_theirPort_8 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_8, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_8);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_8, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_8_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_8, end_str());
}

// print SocketTable_theirPort_9 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_9, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_9);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_9, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_9_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_9, end_str());
}

// print SocketTable_theirPort_10 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_10, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_10);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_10, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_10_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_10, end_str());
}

// print SocketTable_theirPort_11 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_11, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_11);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_11, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_11_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_11, end_str());
}

// print SocketTable_theirPort_12 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_12, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_12);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_12, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_12_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_12, end_str());
}

// print SocketTable_theirPort_13 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_13, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_13);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_13, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_13_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_13, end_str());
}

// print SocketTable_theirPort_14 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_14, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_14);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_14, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_14_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_14, end_str());
}

// print SocketTable_theirPort_15 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_15, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_theirPort_15);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_15, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_theirPort_15_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_theirPort_15, end_str());
}

// print SocketTable_myPort_0 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_0, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_0);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_0, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_0_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_0, end_str());
}

// print SocketTable_myPort_1 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_1, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_1);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_1, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_1_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_1, end_str());
}

// print SocketTable_myPort_2 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_2, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_2);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_2, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_2_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_2, end_str());
}

// print SocketTable_myPort_3 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_3, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_3);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_3, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_3_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_3, end_str());
}

// print SocketTable_myPort_4 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_4, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_4);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_4, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_4_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_4, end_str());
}

// print SocketTable_myPort_5 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_5, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_5);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_5, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_5_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_5, end_str());
}

// print SocketTable_myPort_6 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_6, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_6);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_6, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_6_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_6, end_str());
}

// print SocketTable_myPort_7 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_7, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_7);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_7, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_7_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_7, end_str());
}

// print SocketTable_myPort_8 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_8, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_8);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_8, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_8_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_8, end_str());
}

// print SocketTable_myPort_9 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_9, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_9);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_9, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_9_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_9, end_str());
}

// print SocketTable_myPort_10 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_10, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_10);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_10, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_10_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_10, end_str());
}

// print SocketTable_myPort_11 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_11, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_11);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_11, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_11_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_11, end_str());
}

// print SocketTable_myPort_12 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_12, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_12);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_12, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_12_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_12, end_str());
}

// print SocketTable_myPort_13 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_13, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_13);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_13, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_13_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_13, end_str());
}

// print SocketTable_myPort_14 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_14, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_14);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_14, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_14_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_14, end_str());
}

// print SocketTable_myPort_15 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_15, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_SocketTable_myPort_15);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_15, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_myPort_15_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_myPort_15, end_str());
}

// print SocketTable_valid_0 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_0, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_0);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_0, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_0_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_0, end_str());
}

// print SocketTable_valid_1 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_1, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_1);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_1, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_1_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_1, end_str());
}

// print SocketTable_valid_2 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_2, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_2);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_2, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_2_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_2, end_str());
}

// print SocketTable_valid_3 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_3, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_3);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_3, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_3_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_3, end_str());
}

// print SocketTable_valid_4 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_4, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_4);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_4, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_4_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_4, end_str());
}

// print SocketTable_valid_5 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_5, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_5);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_5, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_5_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_5, end_str());
}

// print SocketTable_valid_6 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_6, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_6);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_6, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_6_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_6, end_str());
}

// print SocketTable_valid_7 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_7, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_7);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_7, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_7_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_7, end_str());
}

// print SocketTable_valid_8 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_8, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_8);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_8, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_8_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_8, end_str());
}

// print SocketTable_valid_9 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_9, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_9);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_9, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_9_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_9, end_str());
}

// print SocketTable_valid_10 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_10, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_10);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_10, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_10_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_10, end_str());
}

// print SocketTable_valid_11 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_11, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_11);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_11, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_11_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_11, end_str());
}

// print SocketTable_valid_12 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_12, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_12);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_12, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_12_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_12, end_str());
}

// print SocketTable_valid_13 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_13, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_13);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_13, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_13_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_13, end_str());
}

// print SocketTable_valid_14 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_14, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_14);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_14, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_14_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_14, end_str());
}

// print SocketTable_valid_15 Transactions
{
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_15, begin_str(AESL_transaction));
{
    sc_bv<1> __xlx_tmp_lv = *((char*)__xlx_apatb_param_SocketTable_valid_15);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_15, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.SocketTable_valid_15_depth);
aesl_fh.write(AUTOTB_TVIN_SocketTable_valid_15, end_str());
}

// print numberSockets Transactions
{
aesl_fh.write(AUTOTB_TVIN_numberSockets, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_numberSockets);
aesl_fh.write(AUTOTB_TVIN_numberSockets, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.numberSockets_depth);
aesl_fh.write(AUTOTB_TVIN_numberSockets, end_str());
}
...
aesl_fh.write(AUTOTB_TVIN_rxUdpDataIn_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_rxUdpDataIn_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_rxUdpDataIn_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_rxUdpDataIn_V_last_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_rxUdpDataIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_rxUdpDataIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_rxUdpDataIn_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_rxUdpDataIn_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_data_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_rxUdpDataIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_rxUdpDataIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_rxUdpDataIn_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_rxUdpDataIn_V_last_V, end_str());
}
...
aesl_fh.write(AUTOTB_TVOUT_txUdpDataOut_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_txUdpDataOut_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_txUdpDataOut_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_txUdpDataOut_V_last_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_txUdpDataOut_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_txUdpDataOut_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_txUdpDataOut_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_txUdpDataOut_V_last_V, end_str());
}
...
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_user_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_last_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVOUT_DataOutApp_V_dest_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataOutApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataOutApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_user_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataOutApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_user_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_user_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataOutApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_dest_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataOutApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_dest_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_OUT_DataOutApp_V_dest_V, end_str());
}
...
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_data_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_keep_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_strb_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_user_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_last_V, begin_str(AESL_transaction));
aesl_fh.write(AUTOTB_TVIN_DataInApp_V_dest_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_data_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_keep_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_DataInApp_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_keep_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_strb_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_DataInApp_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_strb_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_user_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_DataInApp_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_user_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_last_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_DataInApp_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_last_V, end_str());
}

// dump stream ingress status to file
{
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_dest_V, begin_str(AESL_transaction));
if (__xlx_apatb_param_DataInApp_stream_buf_final_size > 0) {
...
aesl_fh.write(WRAPC_STREAM_INGRESS_STATUS_DataInApp_V_dest_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_data_V, begin_str(AESL_transaction));
...
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_data_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_keep_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataInApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_keep_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_keep_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_strb_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataInApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_strb_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_strb_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_user_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataInApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_user_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_user_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_last_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataInApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_last_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_last_V, end_str());
}
{
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_dest_V, begin_str(AESL_transaction));
sprintf(__xlx_sprintf_buffer.data(), "%d\n", __xlx_apatb_param_DataInApp_stream_buf_final_size);
 aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_dest_V, __xlx_sprintf_buffer.data());
aesl_fh.write(WRAPC_STREAM_SIZE_IN_DataInApp_V_dest_V, end_str());
}
// print numberSockets Transactions
{
aesl_fh.write(AUTOTB_TVOUT_numberSockets, begin_str(AESL_transaction));
{
    sc_bv<16> __xlx_tmp_lv = *((short*)__xlx_apatb_param_numberSockets);
aesl_fh.write(AUTOTB_TVOUT_numberSockets, __xlx_tmp_lv.to_string(SC_HEX)+string("\n"));
}
  tcl_file.set_num(1, &tcl_file.numberSockets_depth);
aesl_fh.write(AUTOTB_TVOUT_numberSockets, end_str());
}
