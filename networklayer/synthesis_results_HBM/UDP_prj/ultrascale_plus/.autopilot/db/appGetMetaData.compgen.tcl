...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { DataInApp_TSTRB { I 64 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'DataInApp_V_strb_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { DataInApp_TUSER { I 96 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'DataInApp_V_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { DataInApp_TVALID { I 1 bit } DataInApp_TREADY { O 1 bit } DataInApp_TDEST { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_agmdDataOut \
    op interface \
    ports { agmdDataOut_din { O 1024 vector } agmdDataOut_num_data_valid { I 9 vector } agmdDataOut_fifo_cap { I 9 vector } agmdDataOut_full_n { I 1 bit } agmdDataOut_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { agmdIdOut_din { O 16 vector } agmdIdOut_num_data_valid { I 9 vector } agmdIdOut_fifo_cap { I 9 vector } agmdIdOut_full_n { I 1 bit } agmdIdOut_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 240 \
    name agmdpayloadLenOut \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_agmdpayloadLenOut \
    op interface \
    ports { agmdpayloadLenOut_din { O 16 vector } agmdpayloadLenOut_num_data_valid { I 9 vector } agmdpayloadLenOut_fifo_cap { I 9 vector } agmdpayloadLenOut_full_n { I 1 bit } agmdpayloadLenOut_write { O 1 bit } } \
} "
}
