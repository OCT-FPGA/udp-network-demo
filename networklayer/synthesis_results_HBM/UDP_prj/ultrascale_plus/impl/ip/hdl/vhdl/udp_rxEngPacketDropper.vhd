...
attribute shreg_extract : string;
    ...
    signal tmp_i_179_reg_324_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal currWord_data_V_fu_251_p1 : STD_LOGIC_VECTOR (511 downto 0);
    signal currWord_data_V_reg_328 : STD_LOGIC_VECTOR (511 downto 0);
    signal currWord_keep_V_reg_333 : STD_LOGIC_VECTOR (63 downto 0);
    signal currWord_last_V_fu_265_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal currWord_last_V_reg_338 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln144_fu_157_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((tmp_i_179_nbreadreq_fu_112_p3 = ap_const_lv1_1) and (repd_state = ap_const_lv1_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                currWord_data_V_reg_328 <= currWord_data_V_fu_251_p1;
                currWord_keep_V_reg_333 <= ureDataPayload_dout(575 downto 512);
    ...
    ap_condition_179_assign_proc : process(tmp_i_179_nbreadreq_fu_112_p3, repd_state, currWord_last_V_fu_265_p3)
    begin
                ap_condition_179 <= ((tmp_i_179_nbreadreq_fu_112_p3 = ap_const_lv1_1) and (repd_state = ap_const_lv1_1) and (currWord_last_V_fu_265_p3 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op37_read_state1_assign_proc : process(tmp_i_179_nbreadreq_fu_112_p3, repd_state)
    begin
                ap_predicate_op37_read_state1 <= ((tmp_i_179_nbreadreq_fu_112_p3 = ap_const_lv1_1) and (repd_state = ap_const_lv1_1));
    end process;


    ap_predicate_op53_write_state2_assign_proc : process(repd_state_load_reg_313, tmp_i_179_reg_324, response_drop_V_load_reg_317)
    begin
                ap_predicate_op53_write_state2 <= ((response_drop_V_load_reg_317 = ap_const_lv1_0) and (tmp_i_179_reg_324 = ap_const_lv1_1) and (repd_state_load_reg_313 = ap_const_lv1_1));
    end process;


    ap_predicate_op54_write_state3_assign_proc : process(repd_state_load_reg_313_pp0_iter1_reg, tmp_i_179_reg_324_pp0_iter1_reg, response_drop_V_load_reg_317_pp0_iter1_reg)
    begin
                ap_predicate_op54_write_state3 <= ((response_drop_V_load_reg_317_pp0_iter1_reg = ap_const_lv1_0) and (tmp_i_179_reg_324_pp0_iter1_reg = ap_const_lv1_1) and (repd_state_load_reg_313_pp0_iter1_reg = ap_const_lv1_1));
    end process;
    ...
    currWord_data_V_fu_251_p1 <= ureDataPayload_dout(512 - 1 downto 0);
    ...
    tmp_i_179_nbreadreq_fu_112_p3 <= (0=>(ureDataPayload_empty_n), others=>'-');
    tmp_i_nbreadreq_fu_98_p3 <= (0=>(rthDropFifo_empty_n), others=>'-');
    trunc_ln144_fu_157_p1 <= rthDropFifo_dout(16 - 1 downto 0);
