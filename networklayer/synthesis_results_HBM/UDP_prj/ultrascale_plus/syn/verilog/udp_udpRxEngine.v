...
reg   [35:0] reg_226;
wire   [223:0] trunc_ln674_11_fu_234_p1;
reg   [223:0] trunc_ln674_11_reg_559;
wire   [27:0] trunc_ln674_12_fu_238_p1;
reg   [27:0] trunc_ln674_12_reg_564;
wire   [0:0] grp_fu_198_p1;
reg   [7:0] p_Result_i_reg_580;
reg   [7:0] p_Result_28_i_reg_585;
reg   [7:0] p_Result_29_i_reg_590;
reg   [7:0] p_Result_30_i_reg_595;
reg   [7:0] p_Result_31_i_reg_600;
reg   [7:0] p_Result_32_i_reg_605;
reg   [7:0] p_Result_33_i_reg_610;
reg   [7:0] p_Result_34_i_reg_615;
reg   [7:0] p_Result_35_i_reg_620;
reg   [7:0] p_Result_36_i_reg_625;
reg   [7:0] p_Result_37_i_reg_630;
reg   [7:0] p_Result_38_i_reg_635;
...
wire   [63:0] p_Result_18_fu_428_p5;
wire   [63:0] zext_ln414_2_fu_492_p1;
wire   [1023:0] zext_ln173_3_fu_458_p1;
reg    ap_block_pp0_stage0_01001;
wire   [1023:0] zext_ln173_fu_483_p1;
wire   [1023:0] zext_ln173_2_fu_531_p1;
wire   [35:0] trunc_ln674_10_fu_406_p1;
wire   [287:0] trunc_ln674_fu_402_p1;
wire   [576:0] tmp_20_i_fu_446_p6;
wire   [35:0] trunc_ln414_1_fu_467_p1;
wire   [287:0] trunc_ln414_fu_463_p1;
wire   [576:0] or_ln_fu_471_p5;
wire   [96:0] or_ln173_1_fu_496_p14;
wire   [576:0] or_ln173_2_fu_519_p5;
reg   [0:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_211)) begin
        ...
        end else if (((tmp_1_reg_552 == 1'd1) & (ure_state_load_reg_548 == 2'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_134_p6 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        p_Result_28_i_reg_585 <= {{rxUdpDataIn_TDATA_int_regslice[119:112]}};
        p_Result_29_i_reg_590 <= {{rxUdpDataIn_TDATA_int_regslice[111:104]}};
        p_Result_30_i_reg_595 <= {{rxUdpDataIn_TDATA_int_regslice[103:96]}};
        p_Result_31_i_reg_600 <= {{rxUdpDataIn_TDATA_int_regslice[159:152]}};
        p_Result_32_i_reg_605 <= {{rxUdpDataIn_TDATA_int_regslice[151:144]}};
        p_Result_33_i_reg_610 <= {{rxUdpDataIn_TDATA_int_regslice[143:136]}};
        p_Result_34_i_reg_615 <= {{rxUdpDataIn_TDATA_int_regslice[135:128]}};
        p_Result_35_i_reg_620 <= {{rxUdpDataIn_TDATA_int_regslice[175:168]}};
        p_Result_36_i_reg_625 <= {{rxUdpDataIn_TDATA_int_regslice[167:160]}};
        p_Result_37_i_reg_630 <= {{rxUdpDataIn_TDATA_int_regslice[191:184]}};
        p_Result_38_i_reg_635 <= {{rxUdpDataIn_TDATA_int_regslice[183:176]}};
        p_Result_i_reg_580 <= {{rxUdpDataIn_TDATA_int_regslice[127:120]}};
    end
end

always @ (posedge ap_clk) begin
    if (((~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_134_p6 == 1'd1) & (real_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)) | ((grp_nbreadreq_fu_134_p6 == 1'd1) & (ure_state == 2'd1) & (real_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
...
always @ (posedge ap_clk) begin
    if ((~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_134_p6 == 1'd1) & (real_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((((ure_state_load_reg_548 == 2'd2) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)) | ((ap_predicate_op69_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)) | ((ap_predicate_op84_write_state2 == 1'b1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_done_reg == 1'b1) | ((real_start == 1'b1) & ((ap_done_reg == 1'b1) | ((ap_predicate_op26_read_state1 == 1'b1) & (rxUdpDataIn_TVALID_int_regslice == 1'b0)) | ((rxUdpDataIn_TVALID_int_regslice == 1'b0) & (ap_predicate_op7_read_state1 == 1'b1)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((ap_predicate_op81_write_state2 == 1'b1) & (ureMetaData_full_n == 1'b0)) | ((ure_state_load_reg_548 == 2'd2) & (ureDataPayload_full_n == 1'b0)) | ((ap_predicate_op69_write_state2 == 1'b1) & (ureDataPayload_full_n == 1'b0)) | ((ap_predicate_op84_write_state2 == 1'b1) & (ureDataPayload_full_n == 1'b0)))));
end
...
always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = (((ap_predicate_op81_write_state2 == 1'b1) & (ureMetaData_full_n == 1'b0)) | ((ure_state_load_reg_548 == 2'd2) & (ureDataPayload_full_n == 1'b0)) | ((ap_predicate_op69_write_state2 == 1'b1) & (ureDataPayload_full_n == 1'b0)) | ((ap_predicate_op84_write_state2 == 1'b1) & (ureDataPayload_full_n == 1'b0)));
end

always @ (*) begin
    ap_condition_161 = ((real_start == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_209 = ((grp_nbreadreq_fu_134_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_3_fu_242_p3 == 1'd1) & (grp_fu_198_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_211 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001));
end

always @ (*) begin
    ap_condition_213 = ((grp_nbreadreq_fu_134_p6 == 1'd1) & (ure_state == 2'd1) & (tmp_3_fu_242_p3 == 1'd0) & (grp_fu_198_p1 == 1'd1));
end

always @ (*) begin
    ap_condition_222 = (~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_134_p6 == 1'd1) & (grp_fu_198_p1 == 1'd0));
end
...
always @ (*) begin
    ap_condition_91 = (~(ure_state_load_reg_548 == 2'd2) & ~(ure_state_load_reg_548 == 2'd1) & (tmp_reg_572 == 1'd1));
end
...
always @ (*) begin
    ap_predicate_op26_read_state1 = (~(ure_state == 2'd2) & ~(ure_state == 2'd1) & (grp_nbreadreq_fu_134_p6 == 1'd1));
end

always @ (*) begin
    ap_predicate_op69_write_state2 = ((tmp_1_reg_552 == 1'd1) & (ure_state_load_reg_548 == 2'd1));
end

always @ (*) begin
    ap_predicate_op7_read_state1 = ((grp_nbreadreq_fu_134_p6 == 1'd1) & (ure_state == 2'd1));
end

always @ (*) begin
    ap_predicate_op81_write_state2 = (~(ure_state_load_reg_548 == 2'd2) & ~(ure_state_load_reg_548 == 2'd1) & (tmp_reg_572 == 1'd1));
end

always @ (*) begin
    ap_predicate_op84_write_state2 = (~(ure_state_load_reg_548 == 2'd2) & ~(ure_state_load_reg_548 == 2'd1) & (tmp_last_V_reg_576 == 1'd1) & (tmp_reg_572 == 1'd1));
end
...
assign or_ln173_1_fu_496_p14 = {{{{{{{{{{{{{{{{{{{{{{{{1'd1}, {p_Result_38_i_reg_635}}}, {p_Result_37_i_reg_630}}}, {p_Result_36_i_reg_625}}}, {p_Result_35_i_reg_620}}}, {p_Result_34_i_reg_615}}}, {p_Result_33_i_reg_610}}}, {p_Result_32_i_reg_605}}}, {p_Result_31_i_reg_600}}}, {p_Result_30_i_reg_595}}}, {p_Result_29_i_reg_590}}}, {p_Result_28_i_reg_585}}}, {p_Result_i_reg_580}};

assign or_ln173_2_fu_519_p5 = {{{{{{29'd268435456}, {reg_226}}}, {224'd0}}}, {reg_222}};

assign or_ln_fu_471_p5 = {{{{{{29'd268435456}, {trunc_ln414_1_fu_467_p1}}}, {224'd0}}}, {trunc_ln414_fu_463_p1}};

assign p_Result_18_fu_428_p5 = {{prevWord_keep_V_1[63:36]}, {reg_226}};

assign p_Result_s_fu_410_p5 = {{prevWord_data_V_1[511:288]}, {reg_222}};

assign rxUdpDataIn_TREADY = regslice_both_rxUdpDataIn_V_data_V_U_ack_in;

assign start_out = real_start;

assign tmp_20_i_fu_446_p6 = {{{{{ap_phi_reg_pp0_iter1_sendWord_last_V_reg_174}, {trunc_ln674_12_reg_564}}, {trunc_ln674_10_fu_406_p1}}, {trunc_ln674_11_reg_559}}, {trunc_ln674_fu_402_p1}};

assign tmp_3_fu_242_p3 = rxUdpDataIn_TKEEP_int_regslice[32'd28];

assign trunc_ln414_1_fu_467_p1 = prevWord_keep_V_1[35:0];

assign trunc_ln414_fu_463_p1 = prevWord_data_V_1[287:0];

assign trunc_ln674_10_fu_406_p1 = prevWord_keep_V_1[35:0];

assign trunc_ln674_11_fu_234_p1 = rxUdpDataIn_TDATA_int_regslice[223:0];

assign trunc_ln674_12_fu_238_p1 = rxUdpDataIn_TKEEP_int_regslice[27:0];

assign trunc_ln674_fu_402_p1 = prevWord_data_V_1[287:0];

assign ureMetaData_din = or_ln173_1_fu_496_p14;

assign zext_ln173_2_fu_531_p1 = or_ln173_2_fu_519_p5;

assign zext_ln173_3_fu_458_p1 = tmp_20_i_fu_446_p6;

assign zext_ln173_fu_483_p1 = or_ln_fu_471_p5;
