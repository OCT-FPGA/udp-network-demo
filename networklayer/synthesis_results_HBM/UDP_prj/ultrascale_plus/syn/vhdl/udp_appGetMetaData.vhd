...
attribute shreg_extract : string;
    ...
    signal tmp_last_V_3_reg_256 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal tmp_dest_V_reg_247 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_keep2len_fu_121_ap_ready : STD_LOGIC;
    signal add_ln885_fu_208_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal zext_ln173_4_fu_161_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal zext_ln173_fu_182_p1 : STD_LOGIC_VECTOR (1023 downto 0);
    signal zext_ln223_1_fu_203_p1 : STD_LOGIC_VECTOR (15 downto 0);
    signal add_ln223_fu_224_p2 : STD_LOGIC_VECTOR (15 downto 0);
    signal tmp_23_i_fu_151_p4 : STD_LOGIC_VECTOR (576 downto 0);
    signal tmp_22_i_fu_172_p4 : STD_LOGIC_VECTOR (576 downto 0);
    signal zext_ln223_fu_220_p1 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    add_ln223_fu_224_p2 <= std_logic_vector(unsigned(lenCount_V) + unsigned(zext_ln223_fu_220_p1));
    add_ln885_fu_208_p2 <= std_logic_vector(unsigned(lenCount_V) + unsigned(ap_const_lv16_40));
    ...
    agmdDataOut_din_assign_proc : process(ap_predicate_op16_write_state1, ap_predicate_op32_write_state1, zext_ln173_4_fu_161_p1, zext_ln173_fu_182_p1, ap_condition_229)
    begin
    ...
    agmdIdOut_din <= tmp_dest_V_reg_247;
    ...
    agmdpayloadLenOut_din_assign_proc : process(ap_predicate_op56_write_state2, ap_predicate_op63_write_state2, zext_ln223_1_fu_203_p1, add_ln223_fu_224_p2, ap_condition_236)
    begin
    ...
    ap_condition_391_assign_proc : process(agmd_state_load_reg_231, tmp_i_reg_252, tmp_last_V_3_reg_256)
    begin
                ap_condition_391 <= ((ap_const_lv1_1 = agmd_state_load_reg_231) and (tmp_last_V_3_reg_256 = ap_const_lv1_0) and (tmp_i_reg_252 = ap_const_lv1_1));
    end process;
    ...
    ap_predicate_op56_write_state2_assign_proc : process(agmd_state_load_reg_231, tmp_reg_235, tmp_1_i_reg_239, tmp_last_V_reg_243)
    begin
                ap_predicate_op56_write_state2 <= ((tmp_last_V_reg_243 = ap_const_lv1_1) and (tmp_1_i_reg_239 = ap_const_lv1_1) and (tmp_reg_235 = ap_const_lv1_1) and (ap_const_lv1_0 = agmd_state_load_reg_231));
    end process;


    ap_predicate_op63_write_state2_assign_proc : process(agmd_state_load_reg_231, tmp_reg_235, tmp_i_reg_252, tmp_last_V_3_reg_256)
    begin
                ap_predicate_op63_write_state2 <= ((tmp_reg_235 = ap_const_lv1_1) and (ap_const_lv1_1 = agmd_state_load_reg_231) and (tmp_last_V_3_reg_256 = ap_const_lv1_1) and (tmp_i_reg_252 = ap_const_lv1_1));
    end process;
    ...
    tmp_22_i_fu_172_p4 <= ((DataInApp_TLAST_int_regslice & DataInApp_TKEEP_int_regslice) & DataInApp_TDATA_int_regslice);
    tmp_23_i_fu_151_p4 <= ((DataInApp_TLAST_int_regslice & DataInApp_TKEEP_int_regslice) & DataInApp_TDATA_int_regslice);
    tmp_nbreadreq_fu_58_p8 <= (0=>(DataInApp_TVALID_int_regslice), others=>'-');
    zext_ln173_4_fu_161_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_23_i_fu_151_p4),1024));
    zext_ln173_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_22_i_fu_172_p4),1024));
    zext_ln223_1_fu_203_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(reg_139),16));
    zext_ln223_fu_220_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(reg_139),16));
end behav;
