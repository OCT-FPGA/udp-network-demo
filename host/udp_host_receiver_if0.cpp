...
int main(int argc, char **argv) {
	...
	unsigned int my_ip_address = argc>=5 ? ip_to_hex(argv[4]) : (unsigned int)RECV_IP_ADDR0;
        unsigned int their_ip_address = argc>=6 ? ip_to_hex(argv[5]) : (unsigned int)SEND_IP_ADDR0;
