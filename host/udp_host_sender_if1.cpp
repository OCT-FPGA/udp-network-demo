...
int main(int argc, char **argv) {
	...
	//Network Layer
        ...
        unsigned int my_ip_address = argc>=5 ? ip_to_hex(argv[4]) : (unsigned int)SEND_IP_ADDR1;
        unsigned int their_ip_address = argc>=6 ? ip_to_hex(argv[5]) : (unsigned int)RECV_IP_ADDR1;
	...
	xrt::bo buffer_packetdata = xrt::bo(device, packet_size_total, txkrnl_1.group_id(0));
